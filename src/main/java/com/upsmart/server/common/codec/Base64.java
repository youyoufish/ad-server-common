...
//    }
    ...
    /**
     * encode.
     * As base64 string has no special characters, use US-ASCII encoding to
     * decode result byte array into string, and finally we get the base64 string,
     * not the base64 byte array.
     *
    ...
    public static String toBase64(ByteBuffer data) {
        ...
        // Charset.forName("US_ASCII").decode(ByteBuffer.wrap(result)).toString();
        return StandardCharsets.US_ASCII.decode(ByteBuffer.wrap(result)).toString();
    }
    /**
     * decode.
     * As base64 string has no special characters, use US-ASCII encoding to
     * encode base64 string into byte array, then we use internal API to get
     * result byte array.
     *
    ...
    public static ByteBuffer fromBase64(CharSequence data) {
        ...
        System.arraycopy(buf.array(), buf.arrayOffset(), rawBytes, 0, rawBytes.length);
        return ByteBuffer.wrap(decodeBase64(rawBytes));
    }

    /**
     * decode the origin from base64 string.
     * ATTENTION: malformed input and unmappable characters will
     * always be replaced by the default replace char of the
     * specified Charset.
     * Use the {@link Base64#fromBase64(CharSequence, CharsetDecoder)}
     * method if you need more control over decoding.
     *
    ...
    /**
     * encode the origin to base64 string.
     * ATTENTION: malformed input and unmappable characters will
     * always be replaced by the default replace char of the
     * specified Charset.
     * Use the {@link Base64#toBase64(CharSequence, CharsetEncoder)}
     * method if you need more control over encoding.
     *
